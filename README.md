...
```bash
npm test               # node --test: 249 unit/integration tests
...
- `npm test` — 249 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
