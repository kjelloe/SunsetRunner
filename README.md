...
```bash
npm test               # node --test: 296 unit/integration tests
...
- `npm test` — 296 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
