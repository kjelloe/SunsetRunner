...
```bash
npm test               # node --test: 255 unit/integration tests
...
- `npm test` — 255 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
