...
```bash
npm test               # node --test: 263 unit/integration tests
...
- `npm test` — 263 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
