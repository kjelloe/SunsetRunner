...
```bash
npm test               # node --test: 240 unit/integration tests
...
- `npm test` — 240 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
