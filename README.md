...
```bash
npm test               # node --test: 291 unit/integration tests
...
- `npm test` — 291 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
