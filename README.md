...
```bash
npm test               # node --test: 292 unit/integration tests
...
- `npm test` — 292 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
