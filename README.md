...
```bash
npm test               # node --test: 254 unit/integration tests
...
- `npm test` — 254 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
