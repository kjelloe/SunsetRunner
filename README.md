...
```bash
npm test               # node --test: 266 unit/integration tests
...
- `npm test` — 266 tests: fixed-point/PRNG/hash vectors, reducer + physics, server room, prediction, fairness, and client module loading.
